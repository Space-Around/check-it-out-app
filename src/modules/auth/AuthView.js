...
export default function AuthView({ route, navigation }) {
    ...
    return (
    	<View style={styles.authViewBlock}>
			...
			<View style={styles.authViewBlocks}>
				<Text style={styles.centralText}>{"Let's check it out!"}</Text>
			</View>
			<View style={styles.authViewBlocks}>
				<CustomButton
			...
			<View style={[styles.authViewBlocks, styles.signButtonsBlock]}>
				<CustomButton onPress={() => navigation.navigate('SignIn')} style={styles.favoriteListButton} backgroundColor={blueVersion.transparent} borderColor='black' textColor='black' text='Sign In' width='100%'/>
			</View>
			<View style={[styles.authViewBlocks, styles.signButtonsBlock]}>
				<Text style={styles.separateText}>{'or enter with:'}</Text>
			</View>
			<View style={[styles.authViewBlocks, styles.socailAuthButtonsBlock]}>
				<LogoButton icon='apple'
					onPress={() => {}}
				/>
				<LogoButton icon='google'
					onPress={() => {}}
				/>
				<LogoButton icon='facebook'
					onPress={() => {}}
				/>
			</View>			
			<View style={styles.authViewBlocks}>
