...
export default function TermOfServiceModal(props) {
    return (
      <View>
        <Modal isVisible={props.state}>			
			<View style={styles.termOfServiceModal}>
				<View style={styles.termOfServiceModalHeader}>
					<Text style={styles.termOfServiceModalHeaderText}>{'Term of service'}</Text>
					<TouchableOpacity
...
const styles = StyleSheet.create({
	...
	termOfServiceModalHeader: {
		display: 'flex',
		flexDirection: 'row',
		justifyContent: 'space-between'
	},
	termOfServiceModalHeaderText: {
		fontSize: 25,
		fontWeight: 'bold',
		color: 'black',
	},
